...
<div class="row">
    <div class="col-md-12">
    <form role="form" action="salva_usuario.php" method="POST">
...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="email_usu" id="nome" required>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="senha_usu" id="nome" required>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="altura" id="nome_real">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="peso" id="nome_real">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="idade" id="nome" required>
  </div>
    ...
    <input type="text" class="form-control" name="objetivo" id="nome" required>
  </div>


  <span class="form-group">Doenças:</span>
